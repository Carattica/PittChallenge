...
//console.log(app + "AAAAAAAAAAAAAAAAAAAaaaa");
...
// time.
const TOKEN_PATH = '{"installed":{"client_id":"309787760900-e8f40nt7qfhosfmkikc4dn9913vlpp6r.apps.googleusercontent.com","project_id":"quickstart-1570863069224","auth_uri":"https://accounts.google.com/o/oauth2/auth","token_uri":"https://oauth2.googleapis.com/token","auth_provider_x509_cert_url":"https://www.googleapis.com/oauth2/v1/certs","client_secret":"L3xZZ1twamOYOf_J0o65miXb","redirect_uris":["urn:ietf:wg:oauth:2.0:oob","http://localhost"]}}';
var credentials = '{"installed":{"client_id":"309787760900-e8f40nt7qfhosfmkikc4dn9913vlpp6r.apps.googleusercontent.com","project_id":"quickstart-1570863069224","auth_uri":"https://accounts.google.com/o/oauth2/auth","token_uri":"https://oauth2.googleapis.com/token","auth_provider_x509_cert_url":"https://www.googleapis.com/oauth2/v1/certs","client_secret":"L3xZZ1twamOYOf_J0o65miXb","redirect_uris":["urn:ietf:wg:oauth:2.0:oob","http://localhost"]}}';
...
fs.readFile('credentials.json', (err, content) => {
  ...
  authorize(JSON.parse(credentials), createEvent);
});
...
function bookAppointment(app) {
  ...
  conv.close("Okay, your appointment is set." );
